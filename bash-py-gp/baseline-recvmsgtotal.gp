set terminal png
set output "baseline-recvmsgtotal.png" 

set xlabel "Number of total metadata entries carried by each message"
...
plot "baseline-recvmsgtotal.data" using 1:2 title "Redundancy=1" with linespoints, \
