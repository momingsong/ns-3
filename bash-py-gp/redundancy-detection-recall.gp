set terminal png
set output "redundancy_detection-recall.png" 
...
set key center at 50000,0.8

plot "redundancy_detection-recall.data" using 1:2 title "Redundancy=1" with linespoints, \
